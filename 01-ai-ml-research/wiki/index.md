...
- [Multica](entities/Multica.md) - Multica 多卡系统（⚠️ 当前废弃）
...
- [multica-command-gateway-spike](sources/multica-command-gateway-spike.md) - ~~命令网关调研~~（已废弃）
- [multica-command-gateway-update-status-spike](sources/multica-command-gateway-update-status-spike.md) - ~~状态更新调研~~（已废弃）
...
- [智能体角色边界](agent/智能体角色边界.md) - ~~各智能体职责边界~~（已废弃）
- [首脑协同总规范](agent/首脑协同总规范.md)
- [智能体执行与验收规范](agent/智能体执行与验收规范.md) - ~~智能体执行与验收~~（已废弃）
...
- [Multica任务管家链路dry-run验证报告](outputs/Multica任务管家链路dry-run验证报告.md) - ~~Multica任务管家链路验证~~（已废弃）
