...
This policy is the shared rule for infrastructure executors. Executors must read and follow this file when they claim, run, report, block, or complete any task.
...
| Coordinator Gateway 线 | 20 minutes | If validating on server, 10 minutes is acceptable. If completed, use none. |
